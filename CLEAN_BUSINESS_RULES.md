...
| three_dog_cap | Hurricane Bath: product | Oracle; DB `bath_appointments.dog_count` CHECK (1-3) + RPC; booking form counter stops at 3. Not shown to customers (Villages HOA limit, a data point, not a Dog Gone rule) | n/a |
