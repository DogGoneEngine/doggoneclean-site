...
All client records in `clients.json` were built from the per-client **contact sheets**
(the authoritative source), cross-checked against Paul's correction files and calendar
history. The rough calendar extract was used only as a sanity check, never as a record.

## Drive locations

- Contact-sheet folder: `1oTHLDKe6ao-Q39OoudL058PezwXX8lQG`
- Handoff + supporting files folder: `1L8u0S04O87PduhonJ01TdwnXwqsuyKSM`
  - `HANDOFF_dgc_scheduling` (doc) `1K-R0ZTY27vNp2cVc3DZeiRok-nHVwbhVLteHUaTPzBY` (background; sec 10 task and sec 6 question are SUPERSEDED)
  - `dgc_roster_final` (sheet) `1k-SE1_gLxpSIW1E1JEpK_a5_-DWMDQpRZHEi0v_pNhE` (final classification)
  - `dgc_active_enriched` (sheet) `1uoL3iH589IooLjZoJYctl_nu7dYGdWxaxTvkmQXdaGc` (calendar extract - ROUGH/UNRELIABLE)
  - `dgc_availability.json` `1uVjM8sq9QYBXCQ8DuOWxSsCDT75P--p-` (contact-sheet header digest + notes)
  - `dgc_overrides.json` `1Qd5znlOuGbQr9IwqX6DFpH-fgj8XFVii` (Paul's manual corrections)
...
| Harriet Woolf | 1jMBBMUl2dX_oPDPqq8pmOpJGikq9ZFX4psse5fA6ZAE |
...
| Patricia Angelucci | 1BOZMBauHaeEjlMtSSWl3J_I0QmXA0QtzkKlzPMFoYzY |
| Peter Moran | 1buOr2SWKddXjj8CvyFXP-4lL_DenEECtSkyUzcmAfY0 |
| Ray Russell | 1CW7TgL6dDztrfZMtoqm7aD7wCtpLaYi-EKiaMD6H8l4 |
| Steve Crandall | 1tby6vkZNvx7puneijylNCd4aVXZ3-E3oU-VtXemsgto |
| Terri McDonnell | 14v1Q3hsk72C4gH1SuKMMoHL8kcEPLzVcNnHzoOBKTPo |
| Tonya Hunt | 1-bpLH8eMki4YAihCTLYKOX8qYyv9ahirPSxnP4dYIK0 |
| Patty Brown | NO SHEET |
...
| Russ Walker = Emily (one-off) | 1woOGTQiw4CmksoZqG0Or_-EV-vxH_ytE9C4Gz1zsy7Y |
| Sally O'Laughlin (one-off) | 16imgAA6IQpTw6tjQxAfGS1P0NgP_WqyVVj86CjdIDts |
